...
public abstract class BaseDaoImpl implements BaseDAO {
    ...
    @Override
    public String getRestaurantInfoChained(TSDataSource tsDataSource,
    ...
    @Override
    public void submitRecorrequestReplyUserAlgo1(TSDataSource tsDataSource,
    ...
    @Override
    public void submitRecorrequestReplyUserAlgo2(TSDataSource tsDataSource,
        Connection connection, String flaggedUserId, int algoInd)
        throws TasteSyncException {
        PreparedStatement statement = null;
        ResultSet resultset = null;
    ...
    @Override
    public void submitRestaurantFav(TSDataSource tsDataSource,
    ...
    @Override
    public void submitRestaurantTipsTastesyncAlgo1(TSDataSource tsDataSource,
        Connection connection, String flaggedUserId, String restaurantId,
        ...
        try {
            ...
            throw new TasteSyncException(
                "Error while submitRestaurantTipsTastesyncAlgo1 = " +
                e.getMessage());
        } finally {
            tsDataSource.closeConnection(statement, resultset);
        }
    ...
    @Override
    public void submitRestaurantTipsTastesyncAlgo2(TSDataSource tsDataSource,
        Connection connection, String flaggedUserId, String restaurantId,
        int algoInd) throws TasteSyncException {
        PreparedStatement statement = null;
        ResultSet resultset = null;
        ...
        try {
            ...
            throw new TasteSyncException(
                "Error while submitRestaurantTipsTastesyncAlgo2 = " +
                e.getMessage());
        } finally {
            tsDataSource.closeConnection(statement, resultset);
        }
