...
public class PiUserRecoDAOImpl extends UserRecoDAOImpl implements PiUserRecoDAO {
    @Override
    public List<String> getPiUsersCategoryCityNbrhoodList(String cityId,
    ...
    @Override
    public List<String> getPiUserAlreadyAssignedToUser(String userId)
    ...
    @Override
    public int getCountPiUserCuistier2Match(String recommendationId,
    ...
    @Override
    public int getCountPiRecoUserCuistier2MatchMapper(String recommendationId,
    ...
    @Override
    public int getCountPiRecoUserPriceMatch(String userId,
    ...
    @Override
    public int getCountPiRecoUserThemeMatch(String recommendationId,
    ...
    @Override
    public int getCountPiRecoUserWhoareyouwithMatch(String recommendationId,
    ...
    @Override
    public int getCountPiRecoUserTypeofrestMatch(String recommendationId,
    ...
    @Override
    public int getCountPiRecoUserOccasionMatch(String recommendationId,
    ...
    @Override
    public List<String> getExcludedRecommendationIdList(String userId)
        throws TasteSyncException {
        TSDataSource tsDataSource = TSDataSource.getInstance();
    ...
    @Override
    public void submitPiRecoLog(String userId, String assignedPiUserId,
