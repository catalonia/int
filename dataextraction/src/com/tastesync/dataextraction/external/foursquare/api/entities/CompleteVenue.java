...
public class CompleteVenue extends CompactVenue {
	...
	public String toString() {
		return "CompleteVenue [description=" + description + ", mayor=" + mayor
				+ ", tags=" + Arrays.toString(tags) + ", beenHere=" + beenHere
				+ ", shortUrl=" + shortUrl + ", photos=" + photos
				+ ", timeZone=" + timeZone + ", menu=" + menu + ", rating="
				+ rating + "]";
	}
