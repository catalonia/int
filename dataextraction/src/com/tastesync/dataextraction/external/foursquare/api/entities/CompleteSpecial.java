...
public String toString() {
	return "CompleteSpecial [id=" + id + ", type=" + type + ", message="
			+ message + ", finePrint=" + finePrint + ", description="
			+ description + ", unlocked=" + unlocked + ", icon=" + icon
			+ ", title=" + title + ", state=" + state + ", provider="
			+ provider + ", redemption=" + redemption + ", venue=" + venue
			+ "]";
}
