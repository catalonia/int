...
public String toString() {
	return "CompleteUser [type=" + type + ", contact=" + contact + ", pings="
			+ pings + ", badges=" + badges + ", checkins=" + checkins
			+ ", mayorships=" + mayorships + ", tips=" + tips + ", todos="
			+ todos + ", friends=" + friends + ", followers=" + followers
			+ ", following=" + following + ", requests=" + requests
			+ ", scores=" + scores + "]";
}
