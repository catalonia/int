...
public String toString() {
    return "CompactVenue [id=" + id + ", name=" + name + ", verified="
            + verified + ", contact=" + contact + ", location=" + location
            + ", categories=" + Arrays.toString(categories)+", hereNow=" + hereNow + ", stats="
            + stats + ", url=" + url + ", tips=" + tips + ", todos=" + todos
            + "]";
}
}
