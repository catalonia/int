...
private String id;
  ...
  private String url;
  private TipCompactUser user;
  private CompactVenue venue;
  private TipsLikes likes;

@Override
public String toString() {
	return "CompactTip [id=" + id + ", text=" + text + ", createdAt="
			+ createdAt + ", status=" + status + ", photo=" + photo
			+ ", photourl=" + photourl + ", url=" + url + ", user=" + user
			+ ", venue=" + venue + "]";
}
